  ...
  <div class="row">
    ...
    <div class="col-md-4">
      ...
      <form action="booking.php" method="post">
        ...
        <input type="hidden" name="price" value="6000"> <!-- Add price here -->
    ...
    <div class="col-md-4">
      ...
      <form action="booking.php" method="post">
        ...
        <input type="hidden" name="price" value="5500"> <!-- Add price here -->
        <button type="submit" class="btn btn-outline-primary">Book now</button>
      </form>

      <br><br>
      <span class="amount"><h5>₹ 5,500</h5></span>
    ...
    <div class="col-md-4">
      ...
      <form action="booking.php" method="post">
        ...
        <input type="hidden" name="price" value="5000"> <!-- Add price here -->
        <button type="submit" class="btn btn-outline-primary">Book now</button>
      </form>

      <br><br>
      <span class="amount"><h5>₹ 5,000</h5></span>
    ...
    <div class="col-md-4">
      ...
      <form action="booking.php" method="post">
        ...
        <input type="hidden" name="price" value="4000"> <!-- Add price here -->
        <button type="submit" class="btn btn-outline-primary">Book now</button>
      </form>

      <br><br>
      <span class="amount"><h5>₹ 4,000</h5></span>
    ...
    <div class="col-md-4">
      ...
      <form action="booking.php" method="post">
        ...
        <input type="hidden" name="price" value="8000"> <!-- Add price here -->
        <button type="submit" class="btn btn-outline-primary">Book now</button>
      </form>

      <br><br>  
      <span class="amount"><h5>₹ 8,000</h5></span>
...
<div class="container">
  ...
  <div class="row">
    ...
    <div class="col-md-4">
      ...
      <form action="booking.php" method="post">
        <input type="hidden" name="roomId" value="R101">
        <input type="hidden" name="price" value="6"> <!-- Add price here -->
        <button type="submit" class="btn btn-outline-primary">Book now</button>
      </form>
    ...
    <div class="col-md-4">
      ...
      <form action="booking.php" method="post">
        <input type="hidden" name="roomId" value="R103">
        <input type="hidden" name="price" value="9000"> <!-- Add price here -->
        <button type="submit" class="btn btn-outline-primary">Book now</button>
      </form>
    ...
    <div class="col-md-4">
      ...
      <form action="booking.php" method="post">
        <input type="hidden" name="roomId" value="R106">
        <input type="hidden" name="price" value="60000"> <!-- Add price here -->
        <button type="submit" class="btn btn-outline-primary">Book now</button>
      </form>
